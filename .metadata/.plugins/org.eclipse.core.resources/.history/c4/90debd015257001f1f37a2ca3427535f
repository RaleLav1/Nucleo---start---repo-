...
#define LL_MPU_ACCESS_NOT_BUFFERABLE       0x00U            /*!< Not Bufferable memory attribute */
    ...
    {
        return (READ_BIT(MPU->CTRL, MPU_CTRL_ENABLE_Msk)
                == (MPU_CTRL_ENABLE_Msk));
    }
    ...
    __STATIC_INLINE void LL_MPU_ConfigRegion(uint32_t Region,
            uint32_t SubRegionDisable, uint32_t Address, uint32_t Attributes)
    {
        /* Set Region number */
        WRITE_REG(MPU->RNR, Region);
        /* Set base address */
        ...
        /* Configure MPU */
        WRITE_REG(MPU->RASR,
                (MPU_RASR_ENABLE_Msk | Attributes | SubRegionDisable << MPU_RASR_SRD_Pos));
    }
